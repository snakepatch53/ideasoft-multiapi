...
export default function NotFound({ error = { status: 500 } }) {
    ...
    const description = {
        ...
        404: 'Oops! It seems the page you are looking for is lost in digital space.',
            ...
            <section className="flex min-h-screen items-center justify-center px-4 py-10 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-4xl text-center">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        {/* Error Message */}
                        <h2 className="mb-6 text-3xl font-bold text-white md:text-4xl lg:text-5xl">{title}</h2>
                        <p className="mx-auto mb-8 max-w-2xl text-xl text-balance text-white/80 md:text-2xl">{description}</p>
                        {/* Action Buttons */}
