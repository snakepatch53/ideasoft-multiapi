            ...
            <div className="p-8 space-y-4 relative z-10">
                <Card className="w-96">
                    <CardHeader>
                        ...
                        <CardDescription>Ejemplo de componentes shadcn/ui funcionando con Tailwind CSS 4.1</CardDescription>
                    </CardHeader>
                ...
                <div className="isolate mt-10 max-w-screen-xl mx-auto px-16 xl:px-8 grid grid-cols-1 xl:grid-cols-2 xl:grid-rows-3 gap-8">
                        ...
                        <div className="flex flex-row gap-4">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-sm text-sand-11 group-hover:text-sand-12 transition ease-in-out duration-700">
                                    ...
                                    best practices and developer experience. Through examples, guides and API references, you'll find everything you
                                    need to build your next project. From installation to deployment, we've got you covered.
                                </p>
                            </div>
                        </div>
                    </article>
                    ...
                    <article className="relative p-6 shadow-sm hover:shadow border border-sand-7 hover:border-sand-8 rounded-2xl transition ease-in-out duration-700 group flex flex-row gap-4">
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-sm text-sand-11 group-hover:text-sand-12 transition ease-in-out duration-700">
                                Level up your development and Adonis skills with hours of video content, from beginner to advanced, through databases,
                                testing, and more.
                            </p>
                        </div>
                    </article>
                    ...
                    <article className="relative p-6 shadow-sm hover:shadow border border-sand-7 hover:border-sand-8 rounded-2xl transition ease-in-out duration-700 group flex flex-row gap-4">
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-sm text-sand-11 group-hover:text-sand-12 transition ease-in-out duration-700">
                                Never get lost again, ask questions, and share your knowledge or projects with a growing and supportive community.
                                Join us.
                            </p>
                        </div>
                    </article>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
                        <article className="relative py-4 px-5 bg-white border border-transparent rounded-lg hover:border-sand-8 hover:shadow-sm transition duration-100 ease-in-out group">
                            ...
                            <p className="mt-4 text-sm text-sand-11 group-hover:text-sand-12 transition ease-in-out duration-100">
                                A SQL ORM with a powerful query builder, active record, migrations, and model factories. Everything you need to work
                                with databases.
                            </p>
                        ...
                        <article className="relative py-4 px-5 bg-white border border-transparent rounded-lg hover:border-sand-8 hover:shadow-sm transition duration-100 ease-in-out group">
                            ...
                            <p className="mt-4 text-sm text-sand-11 group-hover:text-sand-12 transition ease-in-out duration-100">
                                A yet simple but feature rich and type-safe form data validation. It comes with 50+ built-in rules and an expressive
                        ...
                        <article className="relative py-4 px-5 bg-white border border-transparent rounded-lg hover:border-sand-8 hover:shadow-sm transition duration-100 ease-in-out group">
                            ...
                            <p className="mt-4 text-sm text-sand-11 group-hover:text-sand-12 transition ease-in-out duration-100">
                                The modern monolithic application architecture. It allows you to build single-page applications without building an
                                API.
                            </p>
                        ...
                        <article className="relative py-4 px-5 bg-white border border-transparent rounded-lg hover:border-sand-8 hover:shadow-sm transition duration-100 ease-in-out group">
                            ...
                            <p className="mt-4 text-sm text-sand-11 group-hover:text-sand-12 transition ease-in-out duration-100">
                                From JSON API tests using Open API schema to browser tests with Playwrighht, it comes with everything you need to test
                                your application.
                            </p>
